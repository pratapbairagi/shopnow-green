...
const CategorySkeleton = () => {
    ...
    return (
            <div className="row" >
                <div className="col col-12 col-sm-12 col-md-5 p-5 video" style={{ padding: "16px", minHeight: "60vh", backgroundPosition: "center", backgroundSize: "cover", backgroundRepeat: "no-repeat" }}>
