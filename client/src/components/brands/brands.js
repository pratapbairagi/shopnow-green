...
const Brands = ({productsFilter}) => {
    ...
    return (
        ...
        {/* <div className="card"> */}
           ...
           return <div key={i} onClick={()=> navigate(`/shop/${v.brand}`) } className="face face1 m-0" style={{border:"1px solid rgb(238, 236, 236)", height:"max-content", padding:"4px 10px", cursor:"pointer"}}>
