        ...
        <div className="container-fluid py-4 category-container">
            ...
            <div className="row" >
                <div className="col col-12 col-sm-12 col-md-5 p-5" style={{ padding: "16px", minHeight: "60vh", backgroundImage: "url('/images/kids-category.jpg')", backgroundPosition: "center", backgroundSize: "cover", backgroundRepeat: "no-repeat" }}>
                    ...
                    <button onClick={()=>navigate("/shop", {state : { gender:"", age:"2-17"}})} className="mt-2" style={{ width: "max-content", float: "left", textDecoration: "none", color: "white", fontSize: "var(--font)" }}>
                        <span>Explore</span>
                        <ArrowRightShort />
                    </button>
                </div>
                ...
                <div className="col col-12 col-sm-12 col-md-6 mt-1 mt-md-0 p-0" style={{ minHeight: "60vh" }} >
                    ...
                    <div className="row p-0 m-0" style={{ height: "100%", display: "flex", flexWrap: "wrap", gap: "8px", padding: "0 4px", width:"100%" }}>
                        <div className="col-6 col1 col-sm-6 col-md-12" style={{ width:"100%", display: "flex", flexDirection: "column", padding: "16px", backgroundImage: "url('/images/womens-category4.jpg')", backgroundPosition: "center", backgroundRepeat: "no-repeat", backgroundSize: "cover", height: "48%"}}>
                            ...
                            <button onClick={()=> navigate("/shop", {state:{ gender:"m", age:"18-70"} })} state={{gender:"f", age:"18-70"}} className="mt-2" style={{ width: "max-content", float: "left", textDecoration: "none", color: "white", fontSize: "var(--font)" }}>
                                <span>Explore</span>
                                <ArrowRightShort />
                            </button>
                        </div>
                        <div className="col-6 col2 col-sm-6 col-md-12 p-5" style={{ padding: "16px", backgroundImage: "url('/images/mens-category-4.jpg')", backgroundPosition: "center", backgroundRepeat: "no-repeat", backgroundSize: "cover", height: "49%", width: "100%" }}>
                            ...
                            <button onClick={()=> navigate("/shop", {state:{ gender:"f", age:"18-70"} })} className="mt-2" style={{ width: "max-content", float: "left", textDecoration: "none", color: "white", fontSize: "var(--font)" }}>
                                <span>Explore</span>
                                <ArrowRightShort />
                            </button>
