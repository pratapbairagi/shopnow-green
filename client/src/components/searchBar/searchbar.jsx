...
const SearchBar = ({toggleSearchBar, search_options, setSearch_options}) => {
    ...
    return(
        <div id={toggleSearchBar} className="d-flex" style={{width:"100%", maxWidth:"1200px", display:"flex", flexDirection:"column", padding:"0 0 16px 0", boxShadow:"grey 0 15px 10px -18px", justifyContent:"center", alignItems:"center", gap:"0", borderBottomLeftRadius:"8px", borderBottomRightRadius:"8px", background:"var(--white)", position:"fixed", top:"-100%", transition:".5s linear", margin:"auto", zIndex:"10", height:"20vh"  }}>
           <h4 className="text-success">SEARCH</h4>
            ...
            { search.length > 1 && <button className="btn btn-dander btn-sm rounded-0" onClick={()=> cancelSearch } style={{width:"25px", height:"25px", position:"absolute", bottom:"12px", background:"transparent", left:"6px", display:"grid", placeItems:"center"}}>
                <XLg size="16"/>
            </button>}
        </div>
    )
