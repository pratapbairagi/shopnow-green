        ...
        <div className="product-card py-1" style={{ background: "white", border: "1px solid #edecec" }}>
            ...
            <div className="product-details" style={{ height: "80%", padding: "3px" }} >
                <div className="clearfix mb-1 d-flex flex-column" style={{ width: "100%" }}>
                    ...
                    <h5 className="card-title p-0 px-1 m-0 text-start rounded-pill bg-primary" style={{ fontSize: "90%", width: "max-content", maxWidth:"100%", display: "-webkit-box", overflow: "hidden", WebkitLineClamp: "1", WebkitBoxOrient: "vertical", color: "white" }}>{products.title}</h5>
