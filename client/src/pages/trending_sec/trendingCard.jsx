           ...
           <div className="product-card py-1" style={{background:"white", border:"1px solid #edecec"}}>
            ...
            <img style={{ width: "90%", height:"90%" }} src={products.images[0]?.url} alt={products.title} />
                ...
                <div className="clearfix mb-1 d-flex flex-column" style={{width:"100%"}}>
                    <span title={products.title} className="product-catagory m-0 text-start px-2 rounded-pill bg-primary" style={{width:"max-content", fontSize:"60%", height:"22px", maxWidth:"100%", display:"-webkit-box", overflow:"hidden", WebkitLineClamp:"1", WebkitBoxOrient:"vertical"}}>{products.title}</span>
