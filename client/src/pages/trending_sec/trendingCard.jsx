        ...
        <div className="product-card py-1" style={{ background: "white", border: "1px solid #edecec" }}>
            ...
            <div className="product-details" style={{ height: "80%", padding: "3px" }} >
                <div className="clearfix mt-0 mb-1 d-flex flex-column" style={{ width: "100%" }}>
                    ...
                    <h6 className="card-title py-1 px-2 m-0 text-start rounded-pill bg-primary" style={{ fontSize: "75%", width: "max-content", maxWidth:"100%", display: "-webkit-box", overflow: "hidden", WebkitLineClamp: "1", WebkitBoxOrient: "vertical", color: "white", lineHeight:"150%" }}>{products.title}</h6>
